...
default_all(void)
{
	...
	default_line("logfile_daemon /home/ylu/test/squid/libexec/logfile-daemon");
	default_line("cache_log /home/ylu/test/squid/var/logs/cache.log");
	default_line("cache_store_log /home/ylu/test/squid/var/logs/store.log");
	...
	default_line("mime_table /home/ylu/test/squid/etc/mime.conf");
...
#endif
	default_line("pid_filename /home/ylu/test/squid/var/logs/squid.pid");
	...
	default_line("netdb_filename /home/ylu/test/squid/var/logs/netdb.state");
	...
	default_line("diskd_program /home/ylu/test/squid/libexec/diskd-daemon");
#if USE_UNLINKD
	default_line("unlinkd_program /home/ylu/test/squid/libexec/unlinkd");
#endif
#if USE_ICMP
	default_line("pinger_program /home/ylu/test/squid/libexec/pinger");
#endif
	...
	default_line("icon_directory /home/ylu/test/squid/share/icons");
	default_line("global_internal_static on");
	default_line("short_icon_urls off");
	default_line("error_directory /home/ylu/test/squid/share/errors/English");
...
#if USE_DNSSERVERS
	default_line("cache_dns_program /home/ylu/test/squid/libexec/dnsserver");
#endif
#if USE_DNSSERVERS
...
defaults_if_none(void)
{
	...
	if (check_null_cachedir(Config.cacheSwap)) {
		default_line("cache_dir ufs /home/ylu/test/squid/var/cache 100 16 256");
	}
#if USE_WCCPv2
