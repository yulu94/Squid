...
#
# $Id: Makefile.in,v 1.56.2.4 2010/03/14 20:27:03 squidadm Exp $
#
...
ACLOCAL = ${SHELL} /home/ylu/test/cfgaux/missing --run aclocal-1.10
ALLOCA = 
AMTAR = ${SHELL} /home/ylu/test/cfgaux/missing --run tar
AR = /usr/bin/ar
AR_R = /usr/bin/ar r
AUTH_LIBS = libbasic.a
AUTH_MODULES = basic
AUTH_OBJS = auth/libbasic.a
AUTOCONF = ${SHELL} /home/ylu/test/cfgaux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/ylu/test/cfgaux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/ylu/test/cfgaux/missing --run automake-1.10
AWK = mawk
BASIC_AUTH_HELPERS = 
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/ylu/test/cfgaux/missing --run makeinfo
MKDIR = /bin/mkdir
MKDIR_P = /bin/mkdir -p
MV = /bin/mv
...
XTRA_LIBS = -lm -lcap
XTRA_OBJS = 
abs_builddir = /home/ylu/test
abs_srcdir = /home/ylu/test
abs_top_builddir = /home/ylu/test
abs_top_srcdir = /home/ylu/test
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = $(SHELL) /home/ylu/test/cfgaux/install-sh
...
SUBDIRS = lib  scripts src icons errors doc helpers tools
